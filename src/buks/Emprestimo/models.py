...
class Emprestimo(models.Model):
    ...
    cliente = models.OneToOneField(Cliente, on_delete=models.PROTECT, verbose_name="Cliente")
    livro = models.OneToOneField(Livro, on_delete=models.PROTECT, verbose_name="Livro")
